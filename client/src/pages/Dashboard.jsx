  ...
  return (
    <div>
      <div className="flex flex-col gap-6 lg:flex-row lg:gap-10">
        <div className="order-2 flex flex-col gap-6 lg:flex-row lg:gap-10">
        ...
        <div className="order-3">
          ...
          ipsa, saepe rerum ab fugit perferendis laboriosam commodi inventore
          sed sapiente eveniet veritatis quam error eos nesciunt, laudantium
          facilis suscipit officiis?
        </div>
      </div>
    </div>
  );
